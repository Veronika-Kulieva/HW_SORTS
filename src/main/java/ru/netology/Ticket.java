...
public class Ticket implements Comparable<Ticket> { // чтобы класс по умолчанию сравнивался (+реализовать методы в интерфейсе)
    ...
    public boolean equals(Object o) {
        ...
        return price == ticket.price // сравнивает все нижние поля, чтобы убедиться, что билеты одинаковые
    ...
    public int compareTo(Ticket o) {
        return price - o.price; //  вместо 0 ставим price и вычитаем цену, которую нам передали
    }
}